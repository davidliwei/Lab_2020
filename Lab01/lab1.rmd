...
author: "Wei Li, GENO 8238, updated from STAT115 labs (author: Qing Zhang)"
...
- Variable
- Conditional
- Sign up for GWU Pegasus/Cereberus
]
...
Homework files will be provided in several sources depending on thir type/size. Blackboard will contain the problem sets and you will submit your completed homework here. GitHub will also contain the problem sets as well as necessary (small) datasets, etc. The Pegasus/Cerberus cluster will contain larger datafiles (/CHILDRENS/groups/ligrp/GENO8232/) and will be necessary for high performance computing later in the semester.
...
Now make sure to open the markdown document and follow along! Download from blackboard.
...
- Navigate to the github page (https://github.com/davidliwei/Lab_2020/)

- Click on the Lab 1 repository

- Click the "Clone or download" button.
    - Either Download Zip and open in finder/explorer. Open in RStudio.
    - Alternatively, copy the URL to the clipboard (https://github.com/davidliwei/Lab_2020.git). Switch to RStudio. Click the "Project (None)" button in the near the top menu bar. Click "New Project", "Version Control", "Git", then paste the URL into the first box.
    - Third option, download from blackboard and open/save as a new R markdown file (.Rmd).
...
You do not need to be an expert in it! Most of the time you will write a program locally and use file transfer tool, e.g. scp
...
An example to find the largest number of all three user inputs. Please be careful about the indentation.
...
# Please signup for Pegasus/Cerberus!
